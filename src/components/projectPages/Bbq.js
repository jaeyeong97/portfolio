...
const Bbq = () => {
    ...
    return (
        <div className="bbq components_wrap" id="pj_top">
            <PjHeader />
            <main className="main">
                <div className="main_img">BBQ 메인 이미지</div>
                <div className="main_txt_wrap_center">
                    <div className="main_txt_wrap">
                        <div className="main_txt">
                            <h2 className="title">BBQ</h2>
                            <span className="t1">BBQ 웹사이트</span>
            ...
            <section>
                ...
                <div className="explain">
                    <div>• 기존 웹사이트 보다 더 현대적이고 사용자 친화적인 디자인을 구현</div>
                </div>
            </section>
            <section>
                <h3 className="ex_title">👀변경된 부분</h3>
                <div className="explain">
                    <div>• <span className="em">반응형 디자인</span> 을 적용하여 사용자의 디바이스에 맞는 적절한 화면 구성을 하였습니다.</div>
                    <div>• 메인슬라이더 영역의 <span className="em">커서 이미지</span> 를 변경, <span className="em">keyframes</span> 를 이용하여 애니메이션을 추가해 사용자에게 시각적 흥미를 주었습니다.</div>
                </div>
            </section>
            <section>
                <h3 className="ex_title">✨결과 및 알게된 점</h3>
                <div className="explain">
                    <div>• 이 프로젝트를 통해 다양한 웹사이트들의 구조를 학습할 수 있었습니다.</div>
                    <div>• 반응형 웹사이트 디자인에 대한 실전 경험을 쌓을 수 있었습니다.</div>
                </div>
            </section>
