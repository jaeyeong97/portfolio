...
const Section2 = () => {
  ...
  const skillsExplain = {
    ...
    cssEx:
      "사용자 경험, 사용자 인터페이스에 적합하게 웹페이지를 구현합니다. Keyframes를 사용하여, 여러 애니메이션 작업을 할 수 있습니다.",
    jsEx: "기본 문법을 습득하고, 웹페이지에 동적인 요소를 추가해본 경험이 있습니다.",
    tsEx: "타입을 지정하여 코드의 안전성과 가독성을 높힌 경험이 있습니다.",
    reactEx:
      "리액트훅을 활용하여 프로젝트를 만든 경험이 있습니다. Styled-component를 활용해본 경험이 있습니다.",
    jqueryEx:
      "기본 문법을 습득하고, 아코디언 UI, 슬라이더등 동적인 애니메이션을 간소화하여 제작한 경험이 있습니다.",
    nodejsEx: "HTTP 메서드를 사용해 외부 데이터를 가져오고 활용한 경험이 있습니다.",
    psEx: "포토샵을 사용하여 사이즈 변경, 누끼따기등 기본적인 이미지 편집을 한 경험이 있습니다.",
    figmaEx: "피그마를 사용하여 프로토타입을 제작한 경험이 있습니다.",
    githubEx: "프로젝트를 리포지토리에 추가 및 수정을 한 경험이 있습니다.",
    vscEx:
